...
class AvaliacoesController extends AppController
{
    ...
    public function index()
    {
        ...
        if ($this->request->getQuery("sort") === null) {
            $avaliacoes->order(["estagiario_id" => "ASC"]);
        }
        $this->set("user", $user);
    ...
    public function avaliacoes($id = null)
    {
        ...
        if ($estagiario_id === null) {
            ...
            $registro = $this->Avaliacoes->Estagiarios
                ->find()
                ->where(["Estagiarios.id" => $estagiario_id])
                ->first();
            /**  Captura os estágios do aluno */
            $estagios = $this->Avaliacoes->Estagiarios
                ->find()
                ->contain([
                    "Estudantes",
                    "Instituicoes",
    ...
    public function supervisoravaliacao($id = null)
    {
        ...
        if (empty($cress)) {
            ...
            $estagiario = $this->Avaliacoes->Estagiarios
                ->find()
                ->contain([
                    "Supervisores",
                    "Alunos",
    ...
    public function add($id = null)
    {
        ...
        if ($estagiario_id == null) {
            ...
            $avaliacaoestagiario = $this->Avaliacoes
                ->find()
        ...
        if ($id == null) {
            if ($user->categoria == "2") {
                ...
                if ($estagiario) {
                    ...
                    $this->Flash->error(
                        __("Selecionar o estudante estagiário"),
                    );
                    return $this->redirect([
