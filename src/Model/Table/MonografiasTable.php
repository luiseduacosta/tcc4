...
class MonografiasTable extends Table {
    ...
    public function initialize(array $config): Void {
        ...
        /*
          $this->belongsTo('Coorientador', [
          'className' => 'Docentes'
          'foreignKey' => 'co_orienta_id',
          ]);
        */
        ...
        /*
          $this->belongsTo('Classificamonografias', [
    ...
    public function validationDefault(Validator $validator): Validator {
        ...
        /*
          $validator
          ->integer('classificamonografia_id')
          ->allowEmptyString('classificamonografia_id');
         */
        /*
          $validator
          ->scalar('data_defesa')
    ...
    public function buildRules(RulesChecker $rules): RulesChecker {
        ...
        // $rules->add($rules->existsIn(['co_orienta_id'], 'Docentes'));
