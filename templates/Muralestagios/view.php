            ...
            <div id="instituicao" class="tab-pane container active show">
                ...
                <table class='table-responsive'>
                    ...
                    <tr>
                        ...
                        <td><?= $muralestagio->dataSelecao ? date('d-m-Y', strtotime($muralestagio->dataSelecao)) : '' ?></td>
                    </tr>
                    <tr>
                        <th><?= __('Data de encerramento da inscrição') ?></th>
                        <td><?= $muralestagio->dataInscricao ? date('d-m-Y', strtotime($muralestagio->dataInscricao)) : '' ?></td>
                    </tr>
                    <tr>
                        <th><?= __('Data fax') ?></th>
