...
<div class="container col-lg-8 shadow p-3 mb-5 bg-white rounded">
    ...
    <fieldset>
        ...
        echo $this->Form->control('endereco', ['label' => 'Endereço', 'type' => 'text']);
        echo $this->Form->control('bairro', ['label' => 'Bairro', 'type' => 'text']);
        echo $this->Form->control('municipio', ['label' => 'Município', 'type' => 'text']);
        echo $this->Form->control('codigo_tel', ['label' => 'DDD', 'type' => 'number']);
        echo $this->Form->control('telefone', ['label' => 'Telefone', 'type' => 'text']);
        echo $this->Form->control('codigo_cel', ['label' => 'DDD', 'type' => 'number']);
        echo $this->Form->control('celular', ['label' => 'Celular', 'type' => 'text']);
        echo $this->Form->control('email', ['label' => 'E-mail', 'type' => 'email']);
        echo $this->Form->control('escola', ['label' => 'Escola de origem', 'type' => 'text']);
        echo $this->Form->control('ano_formatura', ['label' => 'Ano de formatura', 'type' => 'number']);
