    ...
    <div class="container">
        <aside class="column">
            <div class="side-nav">
                ...
                <?= $this->Html->link(__('Editar Estudante'), ['action' => 'edit', $estudante->id], ['class' => 'side-nav-item']) ?>
                <?php if ($this->getRequest()->getAttribute('identity')['categoria'] == 1): ?>
                    <?= $this->Form->postLink(__('Excluir Estudante'), ['action' => 'delete', $estudante->id], ['confirm' => __('Are you sure you want to delete # {0}?', $estudante->id), 'class' => 'side-nav-item']) ?>
                    <?= $this->Html->link(__('Listar Estudantes'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
                    <?= $this->Html->link(__('Novo Estudante'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
                <?php endif; ?>
            </div>
        </aside>
