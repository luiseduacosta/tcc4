...
<div class="container col-lg-8 shadow p-3 mb-5 bg-white rounded">
    ...
    <fieldset>
        ...
        echo $this->Form->control('registro', ['readonly', 'value' => $aluno->registro]);
        echo $this->Form->control('ingresso', ['readonly', 'value' => $aluno->ingresso]);
        echo $this->Form->control('turno', ['options' => ['diurno' => 'Diurno', 'noturno' => 'Noturno'], 'value' => $aluno->turno]);
        echo $this->Form->control('codigo_telefone', ['label' => ['text' => 'DDD'], 'value' => $aluno->codigo_telefone]);
        echo $this->Form->control('telefone', ['value' => $aluno->telefone]);
        echo $this->Form->control('codigo_celular', ['label' => ['text' => 'DDD'], 'value' => $aluno->codigo_celular]);
        echo $this->Form->control('celular', ['value' => $aluno->celular]);
        echo $this->Form->control('email', ['value' => $aluno->email]);
        ...
        echo $this->Form->control('nascimento', ['value' => $aluno->nascimento, 'empty' => true]);
        ...
        echo $this->Form->control('municipio', ['value' => $aluno->municipio]);
        echo $this->Form->control('bairro', ['value' => $aluno->bairro]);
