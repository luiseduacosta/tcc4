            ...
            <div class="top-nav-links">
                <ul>
                    ...
                    <?php if (isset($user) && !empty($user)): ?>
                        <li class='button float-right nav-link'><?= 'Usuário: ' . $user->email ?></li>
                    <?php else: ?>
                        <li class='button float-right nav-link'><?= 'Usuário: ' . 'Visitante' ?></li>
                    <?php endif; ?>
                    <li class="button float-right nav-link">
                        <?= $this->Html->link('Mural', ['controller' => 'muralestagios', 'action' => 'index']) ?>
                    </li>
                    <li class="button float-right nav-link">
                        <?= $this->Html->link('Monografias', ['controller' => 'monografias', 'action' => 'index']) ?>
                    </li>
