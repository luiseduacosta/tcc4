...
<div class="container col-lg-8 shadow p-3 mb-5 bg-white rounded">
    ...
    <p>
        <?php if (isset($user->categoria) && $user->categoria == '1'): ?>
            <?= $this->Html->link('Dados funcionais', ['controller' => 'Professores', 'action' => 'index0'], ['class' => 'btn float-end']) ?>
            <?= $this->Html->link('Dados pessoais', ['controller' => 'Professores', 'action' => 'index1'], ['class' => 'btn float-end']) ?>
            <?= $this->Html->link('Dados graduação', ['controller' => 'Professores', 'action' => 'index2'], ['class' => 'btn float-end']) ?>
            <?= $this->Html->link('Dados pósgraduação', ['controller' => 'Professores', 'action' => 'index3'], ['class' => 'btn float-end']) ?>
        <?php endif; ?>
    </p>
