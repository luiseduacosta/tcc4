            ...
            <tbody>
                <?php foreach ($questiones as $questione): ?>
                    <tr>
                        ...
                        <td class="table-info">
                            <?= $this->Html->link(__('Ver'), ['action' => 'view', $questione->id]) ?>
                            <?= $this->Html->link(__('Editar'), ['action' => 'edit', $questione->id]) ?>
                            <?= $this->Form->postLink(__('Excluir'), ['action' => 'delete', $questione->id], ['confirm' => __('Are you sure you want to delete # {0}?', $questione->id)]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
